function plot1() {
  ...
  //Read the data
  d3.csv('/csv/plot2.csv', function(data) {
    ...
    svg.append('g')
      ...
      .append("circle")
        ...
        .attr("cy", function (d) { return y(d.repo_count); } )
        .attr("r", 5)
        .style("fill", "#69b3a2")
...
function plot2() {
  ...
  // Parse the Data
  d3.csv("/csv/plot1.csv", function(data) {
  ...
  svg.selectAll("mybar")
    ...
    .append("rect")
      ...
      .attr("y", function(d) { return y(d.repo_count); })
      .attr("width", x.bandwidth())
      .attr("height", function(d) { return height - y(d.repo_count); })
      .attr("fill", "#69b3a2")
