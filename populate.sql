...
insert into repo(repo_id, user_id, name, deep_link, related_link) values (1, 1, 'test2', 'test2', 'test2');
insert into repo(repo_id, user_id, name, deep_link, related_link) values (2, 1, 'test2', 'test2', 'test2');
insert into repo(repo_id, user_id, name, deep_link, related_link) values (3, 2, 'test2', 'test2', 'test2');
...
insert into note(note_id, repo_id, meta, body) values (1, 2, 'test2', 'test2');
insert into note(note_id, repo_id, meta, body) values (2, 2, 'test2', 'test2');
insert into note(note_id, repo_id, meta, body) values (3, 2, 'test2', 'test2');